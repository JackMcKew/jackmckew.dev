...
def init_flickr(sender):
    ...
    settings = {
        "FLICKR_API_KEY": {"mandatory": True,},
        "FLICKR_USER": {"mandatory": True,},
        "FLICKR_OUTPUT_DIRNAME": {"mandatory": False, "default": "flickr",},
        "FLICKR_UPDATE": {"mandatory": False, "default": True,},
        "FLICKR_CACHE": {"mandatory": False, "default": True,},
        "FLICKR_SETS_EXCLUDE": {"mandatory": False, "default": None,},
    }
