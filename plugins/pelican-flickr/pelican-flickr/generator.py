...
class FlickrGenerator(generators.Generator):
    ...
    def __init__(self, context, settings, path, theme, output_path, **kwargs):
        ...
        super(FlickrGenerator, self).__init__(
    ...
    """
        ...
        writer.write_file(
            photoset.generated_path, template, self.context, rurls, override_output=True
        )
    ...
    """
        ...
        rurls = self.settings["RELATIVE_URLS"]
        writer.write_file(
            photo.generated_path, template, self.context, rurls, override_output=True
        )
