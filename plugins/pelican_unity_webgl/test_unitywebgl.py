...
class TestUnityWebgl(TestCase):
    def test_directive_basic(self):
        ...
        html = [
            '<link rel="stylesheet" href="/test_template_path/template/style.css">',
    ...
    def test_directive_with_params(self):
        ...
        html = [
            '<link rel="stylesheet" href="/games2/template2/style.css">',
        ...
        res = publish_string(
            d, writer_name="html", settings_overrides={"output_encoding": "unicode"}
        )
