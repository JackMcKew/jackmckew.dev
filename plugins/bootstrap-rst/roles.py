...
class h1(nodes.Inline, nodes.TextElement):
    pass


class h2(nodes.Inline, nodes.TextElement):
    pass


class h3(nodes.Inline, nodes.TextElement):
    pass


class h4(nodes.Inline, nodes.TextElement):
    pass


class h5(nodes.Inline, nodes.TextElement):
    pass


class h6(nodes.Inline, nodes.TextElement):
    pass


class label_default(nodes.Inline, nodes.TextElement):
    pass


class label_muted(nodes.Inline, nodes.TextElement):
    pass


class label_primary(nodes.Inline, nodes.TextElement):
    pass
